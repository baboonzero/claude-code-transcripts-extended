...
:root {
    ...
    --code-bg: #263238;
    --code-text: #aed581;
    --tool-reply-bg: #fff8e1;
    --tool-reply-border: #ff9800;
    --tool-reply-label: #e65100;
    --write-tool-bg-start: #e3f2fd;
    --write-tool-bg-end: #e8f5e9;
    --write-tool-border: #4caf50;
    --write-header-color: #2e7d32;
    --write-fade: #e6f4ea;
    --edit-tool-bg-start: #fff3e0;
    --edit-tool-bg-end: #fce4ec;
    --edit-tool-border: #ff9800;
    --edit-header-color: #e65100;
    --edit-fade: #fff0e5;
    --edit-old-bg: #fce4ec;
    --edit-old-label-bg: #f8bbd9;
    --edit-old-label-color: #b71c1c;
    --edit-old-content-color: #880e4f;
    --edit-new-bg: #e8f5e9;
    --edit-new-label-bg: #a5d6a7;
    --edit-new-label-color: #1b5e20;
    --edit-new-content-color: #1b5e20;
    --todo-bg-start: #e8f5e9;
    --todo-bg-end: #f1f8e9;
    --todo-border: #81c784;
    --todo-header-color: #2e7d32;
    --todo-completed-icon: #2e7d32;
    --todo-completed-content: #558b2f;
    --todo-in-progress-icon: #f57c00;
    --todo-in-progress-content: #e65100;
    --todo-pending-icon: #757575;
    --todo-pending-content: #616161;
    --commit-bg: #fff3e0;
    ...
    --header-overlay: rgba(0,0,0,0.03);
    --expand-btn-bg: rgba(0,0,0,0.05);
    --expand-btn-hover: rgba(0,0,0,0.1);
...
@media (prefers-color-scheme: dark) {
    :root:not(.light-mode) {
        ...
        --user-border: #64b5f6;
        --assistant-bg: #1e1e1e;
        --assistant-border: #757575;
        --thinking-bg: #2d2a1f;
        --thinking-border: #ffc107;
        --thinking-text: #b0b0b0;
        --tool-bg: #2a1f2d;
        --tool-border: #ce93d8;
        --tool-result-bg: #1a2b1a;
        --tool-error-bg: #2d1a1a;
        --text-color: #e0e0e0;
        --text-muted: #9e9e9e;
        --code-bg: #0d1117;
        --code-text: #aed581;
        --tool-reply-bg: #2d2a1f;
        --tool-reply-border: #ff9800;
        --tool-reply-label: #ffb74d;
        --write-tool-bg-start: #1a2634;
        --write-tool-bg-end: #1a2b1a;
        --write-tool-border: #66bb6a;
        --write-header-color: #81c784;
        --write-fade: #1a2b1a;
        --edit-tool-bg-start: #2d2a1f;
        --edit-tool-bg-end: #2a1f26;
        --edit-tool-border: #ffb74d;
        --edit-header-color: #ffb74d;
        --edit-fade: #2d2a1f;
        --edit-old-bg: #2d1a1a;
        --edit-old-label-bg: #4a1f1f;
        --edit-old-label-color: #ef9a9a;
        --edit-old-content-color: #ef9a9a;
        --edit-new-bg: #1a2b1a;
        --edit-new-label-bg: #1f4a1f;
        --edit-new-label-color: #a5d6a7;
        --edit-new-content-color: #a5d6a7;
        --todo-bg-start: #1a2b1a;
        --todo-bg-end: #1f2d1a;
        --todo-border: #66bb6a;
        --todo-header-color: #81c784;
        --todo-completed-icon: #81c784;
        --todo-completed-content: #a5d6a7;
        --todo-in-progress-icon: #ffb74d;
        --todo-in-progress-content: #ffcc80;
        --todo-pending-icon: #9e9e9e;
        --todo-pending-content: #bdbdbd;
        --commit-bg: #2d2a1f;
        --commit-border: #ff9800;
        --commit-text: #d7ccc8;
        --commit-hash: #ffb74d;
        ...
        --header-overlay: rgba(255,255,255,0.03);
        --expand-btn-bg: rgba(255,255,255,0.05);
        --expand-btn-hover: rgba(255,255,255,0.1);
        --expand-btn-border: rgba(255,255,255,0.1);
        --shadow-color: rgba(0,0,0,0.3);
        --pagination-disabled-border: #444;
    }
}
...
/* Manual light mode override (when user prefers dark but clicks toggle) */
.light-mode {
    --bg-color: #f5f5f5;
    --card-bg: #ffffff;
    --user-bg: #e3f2fd;
...
body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: var(--bg-color); color: var(--text-color); margin: 0; padding: 16px; line-height: 1.6; transition: background-color 0.3s, color 0.3s; }
.container { max-width: 800px; margin: 0 auto; }
h1 { font-size: 1.5rem; margin-bottom: 24px; padding-bottom: 8px; border-bottom: 2px solid var(--user-border); display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px; }
h1 a { color: inherit; text-decoration: none; }
.theme-toggle { background: var(--card-bg); border: 1px solid var(--user-border); border-radius: 8px; padding: 6px 12px; cursor: pointer; font-size: 1rem; color: var(--text-color); display: flex; align-items: center; gap: 6px; transition: background-color 0.2s; }
.theme-toggle:hover { background: var(--user-bg); }
...
.message-header { display: flex; justify-content: space-between; align-items: center; padding: 8px 16px; background: var(--header-overlay); font-size: 0.85rem; }
...
.write-header { color: var(--write-header-color); }
.edit-header { color: var(--edit-header-color); }
...
.edit-old { background: var(--edit-old-bg); }
.edit-old .edit-label { color: var(--edit-old-label-color); background: var(--edit-old-label-bg); }
.edit-old .edit-content { color: var(--edit-old-content-color); }
.edit-new { background: var(--edit-new-bg); }
.edit-new .edit-label { color: var(--edit-new-label-color); background: var(--edit-new-label-bg); }
.edit-new .edit-content { color: var(--edit-new-content-color); }
.edit-content { margin: 0; flex: 1; background: transparent; font-size: 0.85rem; }
.edit-replace-all { font-size: 0.75rem; font-weight: normal; color: var(--text-muted); }
.write-tool .truncatable.truncated::after { background: linear-gradient(to bottom, transparent, var(--write-fade)); }
.edit-tool .truncatable.truncated::after { background: linear-gradient(to bottom, transparent, var(--edit-fade)); }
...
.todo-header { font-weight: 600; color: var(--todo-header-color); margin-bottom: 10px; display: flex; align-items: center; gap: 8px; font-size: 0.95rem; }
...
.todo-completed .todo-icon { color: var(--todo-completed-icon); background: rgba(46, 125, 50, 0.15); }
.todo-completed .todo-content { color: var(--todo-completed-content); text-decoration: line-through; }
.todo-in-progress .todo-icon { color: var(--todo-in-progress-icon); background: rgba(245, 124, 0, 0.15); }
.todo-in-progress .todo-content { color: var(--todo-in-progress-content); font-weight: 500; }
.todo-pending .todo-icon { color: var(--todo-pending-icon); background: var(--expand-btn-bg); }
.todo-pending .todo-content { color: var(--todo-pending-content); }
...
.expand-btn { display: none; width: 100%; padding: 8px 16px; margin-top: 4px; background: var(--expand-btn-bg); border: 1px solid var(--expand-btn-border); border-radius: 6px; cursor: pointer; font-size: 0.85rem; color: var(--text-muted); }
.expand-btn:hover { background: var(--expand-btn-hover); }
...
.index-item-header { display: flex; justify-content: space-between; align-items: center; padding: 8px 16px; background: var(--header-overlay); font-size: 0.85rem; }
.index-item-number { font-weight: 600; color: var(--user-border); }
.index-item-content { padding: 16px; }
.index-item-stats { padding: 8px 16px 12px 32px; font-size: 0.85rem; color: var(--text-muted); border-top: 1px solid var(--border-subtle); }
...
.index-item-commit code { background: var(--inline-code-bg); padding: 1px 4px; border-radius: 3px; font-size: 0.8rem; margin-right: 6px; }
...
.commit-card a:hover { color: var(--commit-hash); }
...
@media (max-width: 600px) { body { padding: 8px; } .message, .index-item { border-radius: 8px; } .message-content, .index-item-content { padding: 12px; } pre { font-size: 0.8rem; padding: 8px; } h1 { font-size: 1.25rem; } .theme-toggle { padding: 4px 8px; font-size: 0.9rem; } }
"""

JS = """
// Theme toggle functionality
(function() {
    const STORAGE_KEY = 'claude-transcript-theme';
    ...
    function setTheme(theme) {
        ...
        if (btn) {
            ...
            if (theme === 'dark' || (theme === 'system' && getSystemPreference() === 'dark')) {
                icon.innerHTML = '&#9728;';
    ...
    function toggleTheme() {
        ...
        if (!stored) {
            // First toggle: override system preference
...
@click.version_option(None, "-v", "--version", package_name="claude-code-transcripts-extended")
def cli():
...
@click.option(
    ...
    "--output",
    type=click.Path(),
    default="./my_patterns.md",
    help="Output path for the knowledge bank (default: ./my_patterns.md).",
)
@click.option(
    "--api-key",
...
@click.option(
    "--extract-only",
    is_flag=True,
    help="Only extract prompts, don't run LLM analysis.",
)
@click.option(
    "--review",
    is_flag=True,
    help="Review previously extracted patterns interactively.",
)
@click.option(
    "--auto-approve",
    is_flag=True,
    help="Automatically approve all patterns (skip interactive review).",
)
@click.option(
    "--update",
    is_flag=True,
    help="Only analyze new sessions since last run.",
)
@click.option(
    "-q",
    "--quiet",
...
def patterns_cmd(source, output, api_key, limit, extract_only, review, auto_approve, update, quiet):
    """Extract patterns from your Claude Code sessions and generate a knowledge bank.
    
    Analyzes your coding assistant conversations to identify:
    - Recurring instructions and preferences
    - Coding style patterns
    - Corrections (revealing implicit preferences)
    
    Examples:
    
      # Run full analysis
      claude-code-transcripts patterns
      
      # Extract prompts only (no API calls)
      claude-code-transcripts patterns --extract-only
      
      # Review patterns interactively
      claude-code-transcripts patterns --review
      
      # Update with new sessions only
      claude-code-transcripts patterns --update
    """
    from .extract_prompts import collect_prompts_for_analysis, get_prompt_stats
    from .pattern_analyzer import AnalysisResult, analyze_all_prompts
    from .knowledge_bank import generate_knowledge_bank
    from .review_cli import review_patterns_interactive, quick_approve_all
    ...
    output = Path(output)
    state_path = output.parent / f".{output.stem}_state.json"
    
    # Handle --review: load existing state and review
    if review:
        if not state_path.exists():
            raise click.ClickException(
                f"No analysis state found at {state_path}. Run analysis first."
            )
        result = AnalysisResult.load(state_path)
        result = review_patterns_interactive(result, state_path)
        generate_knowledge_bank(result, output)
        click.echo(f"\n✓ Knowledge bank updated: {output}")
        return
    
    # Handle --update: load state and only process new sessions
    analyzed_sessions = set()
    if update and state_path.exists():
        prev_result = AnalysisResult.load(state_path)
        # In a real implementation, we'd track session IDs
        # For now, we'll just append new patterns
        if not quiet:
            click.echo(f"Loading previous analysis with {len(prev_result.patterns)} patterns...")
    
    # Extract prompts
    if not quiet:
        click.echo(f"Scanning {source}...")
        stats = get_prompt_stats(source)
        click.echo(f"Found {stats['total_sessions']} sessions with {stats['total_prompts']} prompts")
        click.echo(f"  Instructions: {stats['by_type'].get('instruction', 0)}")
        click.echo(f"  Corrections: {stats['by_type'].get('correction', 0)}")
        click.echo(f"  General: {stats['by_type'].get('general', 0)}")
    
    prompts = collect_prompts_for_analysis(source, limit=limit)
    
    if not prompts:
        click.echo("No prompts found to analyze.")
        return
    
    if extract_only:
        click.echo(f"\n✓ Extracted {len(prompts)} prompts")
        click.echo("Use --review to analyze with LLM.")
        return
    ...
    if not quiet:
        click.echo(f"\nAnalyzing {len(prompts)} prompts with Claude...")
    
    def on_progress(current, total):
        if not quiet:
            click.echo(f"  Processing batch {current}/{total}...")
    ...
    if auto_approve:
        result = quick_approve_all(result)
        if not quiet:
            click.echo("Auto-approved all patterns.")
    else:
        result = review_patterns_interactive(result, state_path)
    
    # Generate knowledge bank
    generate_knowledge_bank(result, output)
    click.echo(f"\n✓ Knowledge bank saved: {output}")
